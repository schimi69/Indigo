...
class DLLEXPORT MoleculeRGroupsComposition {
public:
   MoleculeRGroupsComposition ();
   ~MoleculeRGroupsComposition ();

   static void convolve(BaseMolecule &source, BaseMolecule &target, int rgroup);
   static void convolve(BaseMolecule &source, BaseMolecule &target);

   static void convolve(BaseMolecule &target, int rgroup);
   static void convolve(BaseMolecule &target);
...
protected:
    static void convolve(BaseMolecule &target, PtrPool<BaseMolecule> fragments);
